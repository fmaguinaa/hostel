...
import TutorView from '../components/tutor/TutorLanding'
import TutorNavigation from '../common/tutorNavigation/TutorNavigation'


class TutorOptionsLayout extends Component {
  ...
  render () {
    ...
    // (
    //   <div className="tutor">
    //     <TutorNavigation history={this.props.history}/>
    //     { TutorView() }
    //   </div>
      //Landing
...
export default TutorOptionsLayout//LayoutWrapper
